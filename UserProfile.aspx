<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="FormProject.UserProfile" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="imgs/dummy.jpeg"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="50px" src="imgs/BPCL.NS.png"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           <h4>Filled Form</h4>
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="your Form info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
